...
gj.timepicker.config = {
    base: {
        ...
        icons: {
            rightIcon: '<span class="input-group-append" role="right-icon"><button class="btn btn-outline-secondary border-left-0" type="button"><i class="fa fa-clock-o" aria-hidden="true"></i></button></span>'
        },
